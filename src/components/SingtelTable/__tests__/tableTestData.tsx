...
export const rowdata1: TableRows<Data1>[]  = [
    { key: '1', operator: '*Celcom Axiata (LTE)', headset: 'CELCOM / My Celcom / 502 19', avaliability: '1' },
    { key: '2', operator: '*DiGi Telecom (LTE)', headset: 'DiGi 1800 / DiGi /  MYMY18', avaliability: '2'} ,
    { key: '3',  operator: '*Maxis (LTE)', headset: 'U Mobile / MYS 18 / MY 18', avaliability: '3'} ,
